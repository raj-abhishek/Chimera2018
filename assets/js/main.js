...
$(document).ready(function() {
   ...
   $(".countdown")
       .countdown("2018/11/16", function(event) {
           $(this).html(
               event.strftime('<div>00<span>Weeks</span></div>  <div>%D <span>Days</span></div>  <div>%H<span>Hours</span></div> <div>%M<span>Minutes</span></div> <div>%S<span>Seconds</span></div>')
           );
       });
